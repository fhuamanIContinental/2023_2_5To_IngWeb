...
export class TipoDocumentoANTIGUOService {
  ...
  getByFilter(filtros:FilterPaginationRequest):Observable<FilterPaginationResponse<TipoDocumentoResponse>>
  {
    return this.http.post<FilterPaginationResponse<TipoDocumentoResponse>>(`${this.url}filter`, filtros);
  }
